...
```
Опционально:
Насчет скрипта, можно сделать автоматическое добавление пользователя в конфиг, мне честно говоря лень этим заниматься, так как юзером у меня не много, легче ручками.
